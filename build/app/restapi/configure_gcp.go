...
//go:generate swagger generate server --target ../../app --name Gcp --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/gcp/build/templates --principal interface{}

func configureFlags(api *operations.GcpAPI) {
...
func configureAPI(api *operations.GcpAPI) http.Handler {
